...
const executableName =
  process.platform === 'win32' ? 'defvalidator.exe' : 'defvalidator'
...
if (!existsSync(executablePath)) {
  console.error(
    `Publish completed, but executable was not found: ${executablePath}`,
  )
  process.exit(1)
}
